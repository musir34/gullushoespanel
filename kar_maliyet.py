...
def kar_analiz():
    ...
    # Toplam kâr hesaplanırken, hesapla_kar fonksiyonunun ilk elemanı (net kâr) kullanılıyor
    toplam_kar = sum(hesapla_kar(siparis)[0] for siparis in siparisler)
...
def kar_analiz_excel():
    ...
    data = [{
        ...
        "Ürün Maliyeti": hesapla_kar(siparis)[1],
        "Net Kâr": hesapla_kar(siparis)[0]
